...
export BIRDNET_MIN_CONFIDENCE=0.70
...
De standaard minimale zekerheid is 70%. Pas `BIRDNET_MIN_CONFIDENCE` alleen aan als je bewust meer of minder strenge detecties wilt.
